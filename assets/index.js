...
function best()
{
    ...
    else
    {
        ...
        if(parseInt(Day) > 0)
            oneGBTime=`${parseInt(Day)}days, ${oneGBhours}hrs, ${oneGBminutes}${minutes}, ${oneGBseconds}s `
        if(parseInt(Week) > 0)
            oneGBTime=`${parseInt(Week)}weeks, ${parseInt(Day)}days, ${oneGBhours}hrs, ${oneGBminutes}${minutes}, ${oneGBseconds}s `
        ...
        if(parseInt(fileMinutes)==1)
            minutes = `min`
        fileTime =  `${parseInt(fileWeek)}weeks,${parseInt(fileDay)}days,${fileHours}hrs, ${fileMinutes}${minutes}, ${fileSeconds}s `;
